...
@implementation VVTranslateTool

+ (void)translateZHToARA:(NSString *)ZHStr callback:(void (^)(BOOL, NSString *result))callback{
    [self translateLanguage:VVT_AR_AR str:ZHStr callback:callback];
}
...
/*
 ...
 vie    越南语
 */
+ (NSString *)languageCode:(VVTranslate_LanguageType)languageType {
